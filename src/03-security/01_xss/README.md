...
From the repository root: `npm run start:server-side-mitigation` — **http://localhost:3010** for the CSP demo (port set in `server-side-mitigation/index.js` via `app.listen`).
